<!-- 入口：Claude Code（极薄壳 v1.1）。权威指令源：README.md。其他平台见 codex.md / AGENTS.md。 -->

# Webnovel Writer — Claude Code 入口壳
...
- Claude Code 用户：`.claude/` 已内置 agents / commands / settings(hooks)，斜杠命令 `/webnovel-*` 开箱即用。
