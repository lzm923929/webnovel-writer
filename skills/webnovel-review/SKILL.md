...
| Trigger | Reference |
|---------|-----------|
| always | `${WEBNOVEL_ROOT}/references/shared/core-constraints.md` |
| always | `${WEBNOVEL_ROOT}/references/review-schema.md` |
| 审查涉及爽点或钩子 | `${WEBNOVEL_ROOT}/references/shared/cool-points-guide.md` |
| 审查涉及多线交织 | `${WEBNOVEL_ROOT}/references/shared/strand-weave-pattern.md` |
| blocking issue 需用户裁决 (Step 8) | `${WEBNOVEL_ROOT}/references/review/blocking-override-guidelines.md` |
