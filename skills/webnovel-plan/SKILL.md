...
export SKILL_ROOT="${WEBNOVEL_ROOT:-$PWD}/skills/webnovel-plan"
...
| Step 6 always | 区段 | `${SKILL_ROOT}/${WEBNOVEL_ROOT}/references/genre-profiles.md`（仅当前 genre 的 `### 2.x` 段） |
| Step 6 always | 全文 | `${SKILL_ROOT}/${WEBNOVEL_ROOT}/references/shared/strand-weave-pattern.md` |
| 章纲拆分 always | 区段 | `${SKILL_ROOT}/${WEBNOVEL_ROOT}/references/outlining/plot-signal-vs-spoiler.md` |
| Step 6 需要爽点 | 区段 | `${SKILL_ROOT}/${WEBNOVEL_ROOT}/references/shared/cool-points-guide.md` |
...
| Step 7 追读力分析 | 区段 | `${SKILL_ROOT}/${WEBNOVEL_ROOT}/references/reading-power-taxonomy.md` |
...
必读 `${SKILL_ROOT}/${WEBNOVEL_ROOT}/references/genre-profiles.md` 与 `${SKILL_ROOT}/${WEBNOVEL_ROOT}/references/shared/strand-weave-pattern.md`；按需读取爽点 / 冲突 / 节奏 reference（见读取策略表）。
...
按需读取 `${SKILL_ROOT}/${WEBNOVEL_ROOT}/references/reading-power-taxonomy.md` 与 `${SKILL_ROOT}/references/outlining/chapter-planning.md`。
